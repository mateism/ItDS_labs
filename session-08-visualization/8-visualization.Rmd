...
```{r}
penguin_adv_scatter <- ggplot(penguins, aes(x = flipper_length_mm, y = body_mass_g, colour = species)) +
  geom_point() + 
  labs(
    title = "Advanced plot",
    x = "Flipper Length (mm)",
...
ggplot(penguins, aes(x = body_mass_g)) +
  ...
  theme_minimal() +
  labs(
    title = "Penguins' bodymass distribution",
    x = "Bodymass (g)",
    y = "Number"
  )
...
ggplot(penguins, aes(x = flipper_length_mm, y = body_mass_g, colour = species)) +
  ...
  geom_smooth(method = "lm", inherit.aes = F, aes(x = flipper_length_mm, y = body_mass_g)) +
  theme_minimal() +
  labs(
    x = "Flipper length (mm)",
    y = "Bodymass (g)",
...
ggplot(drop_na(penguins), aes(x = flipper_length_mm, y = body_mass_g, colour = sex)) +
  geom_point() +
  geom_smooth(method = "lm") +
  theme_minimal() +
  labs(
    subtitle = "Omitting observations where sex is NA",
    x = "Flipper length (mm)",
    y = "Bodymass (g)",
    colour = "Species"
  )
